...
def main():
    ...
    while True: # Main program loop.
        for logo in logos: # Handle each logo in the logos list. 
            # Erase the logo's current locations:
            bext.goto(logo[X], logo[Y])
            print('    ', end='') # (!) Try commenting this line out. 

            originalDirection = logo[DIR]

            # See if the logo counces off the corners:
            ...
            # Move the logo. (X moves by 2 becaus the terminal
            ...
            if log[DIR] == UP_RIGHT:
                ...
                logo[X] -= 2
                logo[Y] += 1
        # Display number of courner bounces:
        bext.goto(5, 0)
        bext.fg('white')
...
if __name__ == '__main__':
    try:
        ...
        print()
        print('bouncing DVC Logo, by AL Sweigart')
